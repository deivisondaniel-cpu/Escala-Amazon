...
# ============================================================
# JAVASCRIPT - OCULTAR ELEMENTOS DO STREAMLIT
# ============================================================
...
function eliminarElementosStreamlit() {
    ...
    badgedivs.forEach(el => {
        ...
        if (
            el.className.includes('viewer-badge') ||
            el.innerHTML.includes('Hosted with Streamlit')
        ) {
            el.remove();
        }
    ...
    links.forEach(link => {
        ...
        if (
            ...
            link.innerHTML.includes('Hosted with Streamlit')
        ) {
    ...
    # ========================================================
        ...
        if st.button(
            ...
            if novo_nome and nova_funcao:
                ...
                horario_sugerido = HORARIOS_TURNO[
                    turno_id
                ]
                ...
                if tipo_remocao == "Apenas da semana atual":
                    ...
                    df_banco = df_banco[
                        ~(
                            (df_banco["SemanaID"] == id_semana_ativa)
                            &
                            (df_banco["Nome"] == operador_para_remover)
                        )
                    ]
        ...
        for _, row in df_turno.iterrows():
            ...
            for idx, dia in enumerate(
                ...
                if st.session_state.autenticado:
                    ...
                    horario_retorno = HORARIOS_TURNO[
                        id_turno
                    ]
